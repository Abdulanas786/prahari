        ...
        <div class="modal fade" id="settingsPrahariModal" tabindex="-1" aria-labelledby="settingsPrahariModal" data-bs-keyboard="false"
            aria-hidden="true">
            <!-- Scrollable modal -->
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-end mb-4 gap-3">
                <div class="input-group" style="width: 350px;">
                    ...
                    <input type="text" id="settingsPrahariSearch" class="form-control border-start-0 ps-0 shadow-none" placeholder="Search by Name, Mobile, Prahari ID...">
                </div>
            ...
            <div class="table-responsive">
                <table class="table text-nowrap align-middle" id="settingsPrahariTable" style="width: 100%;">
                    <thead>
                        <tr>
...
<script>
        $(document).ready(function() {
            ...
            $('.addPrahariBtn').on('click', function() {
            ...
            let settingsPrahariTable = $('#settingsPrahariTable').DataTable({
                processing: true,
                serverSide: true,
            ...
            $('#settingsPrahariSearch').on('keyup', function() {
                settingsPrahariTable.search(this.value).draw();
            });
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#settingsPrahariModal').modal('hide');
                            settingsPrahariTable.ajax.reload();

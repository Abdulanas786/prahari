...
@section('page-content')
    <div class="d-flex align-items-center justify-content-between mb-4 mt-4">
        <h4 class="fw-bold mb-0 text-dark fs-4">Payments / Withdrawals</h4>
        <div>
            ...
            <a href="#" id="exportCsvBtn" class="btn btn-success shadow-sm px-4 py-2 fw-medium me-2"><i class="bi bi-file-earmark-spreadsheet"></i> Export CSV</a>
            <button class="btn btn-primary addBtn shadow-sm px-4 py-2 fw-medium">+ Add Payment</button>
        </div>
        ...
        <div class="modal fade" id="userModal" tabindex="-1" aria-labelledby="userModal" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow">
                    ...
                    <form id="paymentsForm" action="{{ url('account/payments') }}" method="POST">
                        @csrf
        ...
        <div class="card-body p-4">
            <div class="d-flex justify-content-end mb-4 gap-3">
                <div class="input-group" style="width: 350px;">
                    ...
                    <input type="text" id="customSearch" class="form-control border-start-0 ps-0 shadow-none" placeholder="Search by Prahari, Amount, Status...">
                </div>
...
$(document).ready(function() {
    ...
    $('#exportCsvBtn').on('click', function(e) {
        e.preventDefault();
        window.location.href = "{{ route('payments.index') }}?export=csv&tab=" + currentTab;
    });
    ...
    $('.custom-tab').on('click', function() {
        ...
        // Update currentTab and reload table
        currentTab = $(this).attr('id') === 'all-tab' ? 'all' : 'withdrawals';
        table.ajax.reload();
    });

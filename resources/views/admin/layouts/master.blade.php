...
<head>
    ...
    <!-- Custom Prahari Styles -->
    <style>
        :root {
            --sidebar-bg: #415262; /* Dark slate gray from the image */
            --sidebar-text: #ffffff;
            --logo-bg: #ffffff;
            --logo-text: #314252;
            --primary-btn: #384b5c;
        ...
        .main-sidebar-header .header-logo-text {
            color: var(--logo-text);
            font-weight: 700;
            font-size: 1.1rem;
            display: flex;
        ...
        .main-sidebar-header .header-logo-text i {
            font-size: 1.4rem;
            color: #8c98a4;
            margin-right: 10px;
        }
...
<body>
    ...
    <script src="
    https://cdn.jsdelivr.net/npm/jquery-validation@1.22.1/dist/jquery.validate.min.js
    "></script>

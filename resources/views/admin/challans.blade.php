...
@section('page-content')
    <div class="d-flex align-items-center justify-content-between mb-4 mt-4">
        <h4 class="fw-bold mb-0 text-dark fs-4">Challans</h4>
        <div>
            ...
            <a href="{{ route('challans.index', ['export' => 'csv']) }}" class="btn btn-success shadow-sm px-4 py-2 fw-medium me-2"><i class="bi bi-file-earmark-spreadsheet"></i> Export CSV</a>
            <button class="btn btn-primary addBtn shadow-sm px-4 py-2 fw-medium">+ Add Challan</button>
        </div>
        ...
        <div class="modal fade" id="userModal" tabindex="-1" aria-labelledby="userModal" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow">
                    ...
                    <form id="challansForm" action="{{ url('account/challans') }}" method="GET" enctype="multipart/form-data">
                        @csrf
        ...
        <!-- View Challan Modal -->
        <div class="modal fade" id="viewChallanModal" tabindex="-1" aria-labelledby="viewChallanModalLabel" aria-hidden="true">
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-end mb-4 gap-3">
                <div class="input-group" style="width: 350px;">
                    ...
                    <input type="text" id="customSearch" class="form-control border-start-0 ps-0 shadow-none" placeholder="Search by Challan ID, Prahari...">
                </div>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.viewBtn', function() {
        ...
        $.get("{{ url('account/challans') }}/" + id + "/edit", function(res) {
            ...
            new bootstrap.Modal('#viewChallanModal').show();
        });
    });

        ...
        <div class="modal fade" id="settingsCasesModal" tabindex="-1" aria-labelledby="userModal" data-bs-keyboard="false"
            aria-hidden="true">
            <!-- Scrollable modal -->
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow">
                    ...
                    <form id="settingsCasesForm" action="{{ url('account/cases') }}" method="GET" enctype="multipart/form-data">
                        @csrf
        ...
        <!-- View Case Modal -->
        <div class="modal fade" id="settingsViewCasesModal" tabindex="-1" aria-labelledby="viewCaseModalLabel" aria-hidden="true">
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-end mb-4 gap-3">
                <div class="input-group" style="width: 350px;">
                    ...
                    <input type="text" id="settingsCasesSearch" class="form-control border-start-0 ps-0 shadow-none" placeholder="Search by Case ID, Prahari...">
                </div>
            ...
            <div class="table-responsive">
                <table class="table text-nowrap align-middle" id="settingsCasesTable" style="width: 100%;">
                    <thead>
                        <tr>
...
$(document).ready(function() {
    ...
    // 🔹 OPEN MODAL
    $('.addCasesBtn').on('click', function() {
        $('#settingsCasesForm')[0].reset();
        $('#cases_id').val('');
    ...
    // 🔹 DATATABLE
    let settingsCasesTable = $('#settingsCasesTable').DataTable({
        processing: true,
        serverSide: true,
    ...
    $('#settingsCasesSearch').on('keyup', function() {
        settingsCasesTable.search(this.value).draw();
    });

    // 🔹 VALIDATION
    $('#settingsCasesForm').validate({
        errorElement: 'div',
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $('#settingsCasesForm')[0].reset();
                    $('#settingsCasesModal').modal('hide');
                    settingsCasesTable.ajax.reload();
                },
    ...
    $(document).on('click', '.viewBtn', function() {
        ...
        $.get("{{ url('account/cases') }}/" + id + "/edit", function(res) {
            ...
            new bootstrap.Modal('#settingsViewCasesModal').show();
        });
    });
